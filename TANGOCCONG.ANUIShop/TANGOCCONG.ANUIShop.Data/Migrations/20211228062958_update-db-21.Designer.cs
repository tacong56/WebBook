...
namespace TANGOCCONG.ANUIShop.Data.Migrations
{
    ...
    [Migration("20211228062958_update-db-21")]
            ...
            modelBuilder.Entity("TANGOCCONG.ANUIShop.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "6cf5b069-aa86-4f5f-91b7-9014158a70fd",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "47bab5db-f03a-4371-9783-563b701e6fb8",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "58ec8e7c-b66b-42c2-9021-bad0a52fd1c4",
            ...
            modelBuilder.Entity("TANGOCCONG.ANUIShop.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2021, 12, 28, 13, 29, 55, 288, DateTimeKind.Local).AddTicks(6894));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "16116e9b-5f97-4cde-84e8-ef243096d1ee",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAiP+71yv7T9gyclMsEZQ3xHA+VvVMcr4EXmjpTZ46T7mkh7brlfj98N+6qFsv/UXw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            State = 0,
                            TimeCreated = new DateTime(2021, 12, 28, 13, 29, 55, 466, DateTimeKind.Local).AddTicks(7693),
            ...
            modelBuilder.Entity("TANGOCCONG.ANUIShop.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2021, 12, 28, 13, 29, 55, 296, DateTimeKind.Local).AddTicks(161));
            ...
            modelBuilder.Entity("TANGOCCONG.ANUIShop.Data.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2021, 12, 28, 13, 29, 55, 380, DateTimeKind.Local).AddTicks(484));
