...
@Component({
  selector: 'app-export-storage-detail',
  templateUrl: './export-storage-detail.component.html',
  styleUrls: ['./export-storage-detail.component.scss']
})
export class ExportStorageDetailComponent extends BaseComponent implements OnInit {
  ...
  customSave() {
    ...
    if (this.formDetail.valid) { 
      if(this.formDetail.get('Id').value > 0) {
        this.exportStorage.update(this.formDetail.value)
          .subscribe(
            (res: any) => {
        ...
        this.exportStorage.create(this.formDetail.value)
          .subscribe(
            (res: any) => {
