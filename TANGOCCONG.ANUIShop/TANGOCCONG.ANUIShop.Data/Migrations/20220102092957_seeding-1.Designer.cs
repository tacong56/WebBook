...
namespace TANGOCCONG.ANUIShop.Data.Migrations
{
    ...
    [Migration("20220102092957_seeding-1")]
            ...
            modelBuilder.Entity("TANGOCCONG.ANUIShop.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 1, 2, 16, 29, 56, 690, DateTimeKind.Local).AddTicks(8815));
            ...
            modelBuilder.Entity("TANGOCCONG.ANUIShop.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 1, 2, 16, 29, 56, 696, DateTimeKind.Local).AddTicks(8843));
            ...
            modelBuilder.Entity("TANGOCCONG.ANUIShop.Data.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 1, 2, 16, 29, 56, 752, DateTimeKind.Local).AddTicks(6604));
