...
export class ExportStorageService {
  ...
  getpaging(limit: any, page: any, ngaytu: any, ngayden: any, sort: any) : Observable<any> {
    ...
    return this.http.get(StaticVaribale.URL + StaticVaribale.PATH.exportStorage.getpaging, {params});
  }

  get(id: any) : Observable<any> {
    return this.http.get(StaticVaribale.URL + StaticVaribale.PATH.exportStorage.get + '/' + id)
  }
  ...
  create(data: any) : Observable<any> {
    ...
    return this.http.post(StaticVaribale.URL + StaticVaribale.PATH.exportStorage.create, body, StaticVaribale.httpOptions);
  }
  ...
  update(data: any) : Observable<any> {
    ...
    dataTemp['ProductId'] = parseInt(dataTemp['ProductId']);
    const body = JSON.stringify(dataTemp);
    return this.http.put(StaticVaribale.URL + StaticVaribale.PATH.exportStorage.update, body, StaticVaribale.httpOptions);
  }
}
