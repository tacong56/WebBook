        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeCreated = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2021, 12, 16, 3, 14, 28, 182, DateTimeKind.Local).AddTicks(5976)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsShowOnHome = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "varchar(45)", maxLength: 45, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Province_Id = table.Column<string>(type: "varchar(6)", maxLength: 6, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeCreated = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2021, 12, 16, 3, 14, 28, 189, DateTimeKind.Local).AddTicks(1670))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeCreated = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2021, 12, 16, 3, 14, 28, 253, DateTimeKind.Local).AddTicks(3400)),
                    TimeUpdated = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UserUpdate = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "varchar(45)", maxLength: 45, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    District_Id = table.Column<string>(type: "varchar(6)", maxLength: 6, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "816a795d-7c2f-4ccf-8e5a-bd86fc20f839", "Admintrator role", "Admin", "admin" },
                    { 2, "88a6a87f-6de7-44b4-b179-fb216c2adc34", "Employee role", "Nhân viên", "employee" },
                    { 3, "171f5cd3-1ec7-4b41-bfe6-ffd7ebf8a3b0", "Customer role", "Khách hàng", "customer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, null, "c6b28e7c-e983-4530-a2d8-a4ef0de8fc04", new DateTime(1997, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "tacong56@gmail.com", true, "Ta", 0, false, "Cong", false, null, "tacong56@gmail.com", "admin", "AQAAAAEAACcQAAAAEG3pmbTrbNXHMGySVhA0KEsZaW4fObH8k7QuelS3DEN3hE4VXoCuxEpoR2zMP/hTjg==", null, false, "", 0, new DateTime(2021, 12, 16, 3, 14, 28, 352, DateTimeKind.Local).AddTicks(1770), false, "admin" });
