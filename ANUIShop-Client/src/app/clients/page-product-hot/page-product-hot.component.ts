...
@Component({
  selector: 'app-page-product-hot',
  templateUrl: './page-product-hot.component.html',
  styleUrls: ['./page-product-hot.component.scss']
})
export class PageProductHotComponent implements OnInit {
